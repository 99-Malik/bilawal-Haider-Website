...
//         <div className="absolute inset-0 bg-gradient-to-r from-[#ED0007]/90 via-[#ED0007]/90 to-[#ED0007]/90 z-10"></div>
...
//                   <span className="text-2xl font-bold text-[#FF0000]">B</span>
//                 </div>
//                 <span className="text-white font-semibold">Bosch Service Center</span>
//               </div>
//             </div>
...
//               Professional Bosch appliance repair services across Dubai and Abu Dhabi
//             </p>
//             <div className="flex flex-col sm:flex-row gap-6 justify-center">
//               <Link
//                 href={`https://wa.me/${phoneNumber}?text=Hello%20I%20need%20your%20help%20with%20my%20Bosch%20appliance%20repairs`}
//                 target="_blank"
//                 className="px-12 py-4 border-2 border-white bg-gradient-to-r from-[#FF000] to-[#FF0000] text-white font-bold rounded-full text-lg hover:scale-105 transition-transform duration-300 shadow-2xl"
//               >
//                 Get Bosch Quote
//               </Link>
//               <Link
//                 href={`https://wa.me/${phoneNumber}?text=Hello%20I%20need%20your%20help%20with%20my%20Bosch%20appliance%20repairs`}
//                 target="_blank"
//                 className="px-12 py-4 border-2 border-white text-white font-bold rounded-full text-lg hover:bg-white hover:text-[#FF0000] transition-all duration-300"
//               >
//                 WhatsApp
//               </Link>
//             </div>
...
//             <div className="bg-white rounded-2xl p-8 shadow-2xl transform hover:scale-105 transition-transform duration-300 border-l-4 border-[#FF0000]">
//               <div className="text-4xl font-bold text-[#FF0000] mb-2">15+</div>
//               <div className="text-gray-600">Years Bosch Experience</div>
//             </div>
//             <div className="bg-white rounded-2xl p-8 shadow-2xl transform hover:scale-105 transition-transform duration-300 border-l-4 border-[#FF0000]">
//               <div className="text-4xl font-bold text-[#FF0000] mb-2">5K+</div>
//               <div className="text-gray-600">Bosch Repairs</div>
//             </div>
//             <div className="bg-white rounded-2xl p-8 shadow-2xl transform hover:scale-105 transition-transform duration-300 border-l-4 border-[#FF0000]">
//               <div className="text-4xl font-bold text-[#FF0000] mb-2">24/7</div>
//               <div className="text-gray-600">Bosch Support</div>
//             </div>
//           </div>
//         </div>
//       </section>
...
//             <h2 className="text-5xl md:text-6xl font-black mb-6 bg-gradient-to-r from-[#ed0007] to-[#ed0007] bg-clip-text text-transparent">
//               Bosch Services
//             </h2>
//             <p className="text-xl text-gray-600 max-w-3xl mx-auto">
//               Expert repair services for all Bosch appliances
//             </p>
//           </div>
//           <LgServices />
//         </div>
...
//       {/* Experience Section */}
//       <section className="py-24 bg-gradient-to-r from-[#ed0007] to-[#ed0007] text-white">
//         <div className="max-w-7xl mx-auto px-6">
//           <HomeQuality />
//         </div>
//       </section>
