  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-4">
      ...
      >
        ...
        {/* Icon */}
        <svg className="relative w-8 h-8 text-white fill-current drop-shadow-lg group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24">
      ...
      <motion.a
        ...
        className="group relative flex items-center justify-center w-14 h-14 bg-primary rounded-full shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:scale-110 transition-all duration-300"
      ...
      >
        ...
        <svg className="w-6 h-6 text-white fill-current" viewBox="0 0 24 24">
          <path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56a.977.977 0 00-1.01.24l-1.57 1.97c-2.83-1.49-5.15-3.8-6.62-6.65l1.97-1.6c.3-.29.4-.7.31-1.11a17.93 17.93 0 01-.56-3.53A.996.996 0 008.01 3H4.03c-.55 0-1 .45-1 1 0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.98c0-.55-.45-1-1-1z" />
        </svg>
      </motion.a>
    </div>
  );
