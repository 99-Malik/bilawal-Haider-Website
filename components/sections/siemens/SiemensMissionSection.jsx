    ...
    <div className="flex justify-center bg-white text-black">
      <div className="flex w-full max-w-7xl flex-col gap-10 px-5 py-20 lg:flex-row">
        ...
        <div className="flex flex-col gap-y-5 lg:w-1/4">
          ...
          <span className="font-light">
            At Appliances Repair Master, our vision is to redefine the standards
        ...
        <div className="flex flex-col gap-y-5 lg:w-1/4">
          ...
          <span className="font-light">
            Our goal at Appliances Repair Master is to establish ourselves as
...
export default SiemensMissionSection;
